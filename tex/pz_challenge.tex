...
\subsection{Challenge Tasks and Submission Mechanism}
...
The $p(z)$ estimates in task 1 and the trained models in task 2 should be provided
in a compressed \texttt{tar} file.
...
\begin{enumerate}
  \item{A file \texttt{tests/test\_{submission}.py} that include the
   ...
   \item{A file \texttt{requirements\_{submission}.txt} that include
...
For the second sub-task, providing trained models and a function to run
estimation using those trained models.   In short, the 
